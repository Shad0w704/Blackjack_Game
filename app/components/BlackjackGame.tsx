...
//     // Calculate final chips correctly
...
//     // Show save prompt if guest just won
...
//             className="bg-yellow-500 text-black font-semibold px-4 py-2 rounded-lg hover:bg-yellow-400 transition-colors"
//           >
//             Sign In
//           </button>
//         ) : (
//           <button
//             onClick={signOut}
//             className="bg-red-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-red-500 transition-colors"
//           >
//             Sign Out
//           </button>
//         )}
              ...
              {gameState === 'player-turn' && (
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="flex gap-6 mt-2">
                    <button 
                      onClick={handleHit}
                      className={`bg-red-600 text-white font-bold px-8 py-4 rounded-lg hover:bg-red-500 transition-all text-xl ${
                        highlightButton === 'hit' 
                    ...
                    <button 
                      onClick={handleStand}
                      className={`bg-yellow-600 text-white font-bold px-8 py-4 rounded-lg hover:bg-yellow-500 transition-all text-xl ${
                  ...
                  <button
                    onClick={getAIAdvice}
                    disabled={loadingAI}
                    className="bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-blue-500 transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed flex items-center gap-2"
                  >
